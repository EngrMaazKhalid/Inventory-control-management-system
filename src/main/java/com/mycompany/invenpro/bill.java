...
public class bill extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item_id", "Item_name", "Quantity", "price", "total_price", "bill_no", "date"
            }
        ) {
...
//            String query = "select item_id,item_name,quantity,price,totprice,MAX(biilno),t_date from bill";
...
//                String bill = rs.getString("MAX(biilno)");
  String bill = rs.getString("biilno");
                String date = rs.getString("t_date");
                jLabel2.setText(bill);
                jLabel4.setText(date);
                model.addRow(new Object[] {id,name,qun,price,mfd,bill,date});
            }
            stmt.close();
            con.close();
        }
