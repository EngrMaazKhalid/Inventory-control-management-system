...
public class addtocart extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        table2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "item_id", "item_name", "quantity", "unit price", "total price", "date"
            }
        ) {
      ...
      //   ProductInformation.categoryChooser = "electronics";
        try {
            ...
            while(rs.next()) {
                ...
                String addt = rs.getString("add_time");
               
                
               model.addRow(new Object[] {id,name,qun,price1,mfd,addt});
            }
            rs.close();
...
//               Class.forName("java.sql.DriverManager");
                c=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521/orcl","system","Student@1234");
                s=c.createStatement();
